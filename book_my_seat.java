...
public class book_my_seat
{
    ...
    double x1 = (int) (Math.random()*1000);
    double x2 = (int) (Math.random()*1000);
    double x3 = (int) (Math.random()*1000);
    double x4 = (int) (Math.random()*1000);
    double x5 = (int) (Math.random()*1000);
    double x6 = (int) (Math.random()*1000);
    double x7 = (int) (Math.random()*1000);
    double x8 = (int) (Math.random()*1000);
    double x9 = (int) (Math.random()*1000);
    ...
    public void structure() throws IOException{
        ...
        System.out.println("                                                             ONE STOP DESTINATION FOR ALL YOUR BOOKING NEEDS");
        System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
        String pass;
        String user;
    ...
    public void Stream () throws IOException {
        ...
        switch (pay) {
            ...
            case 4:
                ...
                System.out.println(" ");
                System.out.println("Payment through " + Wallet);
                System.out.println("You have successfully paid Rs." + str + " through " + Wallet +" Wallet");
                int id6 = (int) Math.round(Math.random() * 1000);
                int id7 = (int) Math.round(Math.random() * 100);
    ...
    public void Music_Shows () throws IOException{
        ...
        for (int MS=0; MS  < shows.length; MS++){
            System.out.printf("2d% 5s% 22s% 22s% %n", MS+1 , shows[MS], venue[MS], cost$[MS]);
        }
    }
