...
public class book_my_seat
{
    ...
    public void Hindi ()throws IOException {
        do {
            System.out.println("             Choose from the Movies below\n");
            hin = new String[]{"K.G.F: Chapter 2 (Hindi)", "Attack: Part 1", "Brahm�?stra", "Prithviraj", "Gehraiyaan", "Heropanti 2", "Gangubai Kathiawadi", "Bhool Bhulayaa 2", "Bacchan Pandey", "The Kashmir Files"};
            int h;
